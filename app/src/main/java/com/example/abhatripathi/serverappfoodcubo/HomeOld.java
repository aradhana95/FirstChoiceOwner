...
import com.example.abhatripathi.serverappfoodcubo.ViewHolder.MenuViewHolder;
import com.example.abhatripathi.serverappfoodcubo.model.Category;
...
//         updateToken(FirebaseInstanceId.getInstance().getToken());
        FirebaseInstanceId.getInstance().getInstanceId().addOnSuccessListener( HomeOld.this,
    ...
    private void showDialog() {
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            private void uploadImage() {
                if (saveUri != null) {
                    final ProgressDialog mDialog = new ProgressDialog(HomeOld.this);
                    ...
                    imageFolder.putFile(saveUri)
                            .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    mDialog.dismiss();
                                    Toast.makeText(HomeOld.this, "Uploaded!!!", Toast.LENGTH_SHORT).show();
                            ...
                            .addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    mDialog.dismiss();
                                    Toast.makeText(HomeOld.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void loadMenu() {
        ...
        adapter = new FirebaseRecyclerAdapter<Category, MenuViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull MenuViewHolder viewHolder, int position, @NonNull Category model) {
                ...
                Picasso.with(HomeOld.this).load(model.getImage())
                        .into(viewHolder.imageView);
                viewHolder.setItemClickListener(new ItemClickListener() {
                    @Override
                    public void onClick(View view, int position, boolean isLongClick) {
                        //send category id and start new activity
                        Intent foodlist = new Intent(HomeOld.this, FoodList.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_order) {
            Intent orders = new Intent(HomeOld.this, OrderStatus.class);
            startActivity(orders);
        } else if (id == R.id.nav_banner) {
            Intent banners = new Intent(HomeOld.this, BannerActivity.class);
            startActivity(banners);
        } else if (id == R.id.nav_message) {
            Intent message = new Intent(HomeOld.this, SendMessage.class);
            startActivity(message);
        } else if (id == R.id.nav_shipper) {
            Intent shippers = new Intent(HomeOld.this, ShipperManagement.class);
