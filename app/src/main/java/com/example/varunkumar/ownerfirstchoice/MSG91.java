...
public class MSG91 extends AsyncTask<String, Void, String> {
    ...
    String authKey = "242306ACg3mcE0ZVMc5bbf40ef";
    String textMessage, senderId, singleNumber, msgSchedule, smsRoute, smsCampaign, smsCountryCode;
    ...
    public String getBalance(String route) {
        try {
            return new MSG91(debugMode).execute("BALANCE", route).get();
        } catch (InterruptedException e) {
            e.printStackTrace();
            return "Exception: " + e;
        } catch (ExecutionException e) {
    ...
    public String changePassword(String oldPass, String newPass) {
        try {
            return new MSG91(debugMode).execute("PASSWORD", oldPass, newPass).get();
        } catch (InterruptedException e) {
            e.printStackTrace();
            return "Exception: " + e;
        } catch (ExecutionException e) {
    ...
    public String validate() {
        try {
            return new MSG91(debugMode).execute("VALIDATE").get();
        } catch (InterruptedException e) {
            e.printStackTrace();
            return "Exception: " + e;
        } catch (ExecutionException e) {
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            System.out.println("MSG91  :  im here 1111");
